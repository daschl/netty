...
public interface BinaryMemcacheResponse extends BinaryMemcacheMessage<BinaryMemcacheResponseHeader> {
  ...
  /**
   * Set the full required {@link BinaryMemcacheResponseHeader}.
   *
   * @param header the required response header.
   */
  BinaryMemcacheResponse setHeader(BinaryMemcacheResponseHeader header);
