...
public interface BinaryMemcacheMessage<H extends BinaryMemcacheMessageHeader> extends MemcacheMessage {
  ...
  /**
   * Set the full required {@link BinaryMemcacheMessageHeader}.
   *
   * @param header the required header.
   */
  BinaryMemcacheMessage setHeader(H header);
  ...
  /**
   * Set the optional extras as a {@link ByteBuf} representation.
   *
