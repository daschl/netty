...
public interface BinaryMemcacheRequest extends BinaryMemcacheMessage<BinaryMemcacheRequestHeader> {
  ...
  /**
   * Set the full required {@link BinaryMemcacheRequestHeader}.
   *
   * @param header the required request header.
   */
  BinaryMemcacheRequest setHeader(BinaryMemcacheRequestHeader header);
